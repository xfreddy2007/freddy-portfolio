...
const worksIntro = props => (
    <div className="flex flex-col w-4/5">
        <div class="flex flex-col">
            ...
            <div className="flex ">
                <Button link="https://burger-builder-a6e21.web.app/">VIEW</Button>
                <Button link="https://github.com/xfreddy2007/burger-builder">Source Code</Button>
            </div>
        </div>
        <div>
            ...
            <ul className="font-serif grid grid-cols-1">
                ...
                <li className="text-sm my-3 xl:text-lg md:text-md">- Back-End: <strong className="bg-gray-200">Firebase</strong></li>
                <li className="text-sm my-3 xl:text-lg md:text-md">- Database: <strong className="bg-gray-200">Firebase</strong></li>
            </ul>
        </div>
    </div>
);
